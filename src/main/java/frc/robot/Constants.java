...
public final class Constants {
    ...
    public static final double AWAY_FEEDFORWARD_VELOCITY = 0.2033;//1/5.04;//0.95/4.7;
    public static final double AWAY_FEEDFORWARD_ACCELERATION = .00204;//0.504;//1/.504;// 1/4.6;
