...
public final class Constants {
    ...
    public static final double DISTANCE_TO_MODULE_0 = Math
            .sqrt((X_POSITIVE_DISTANCE_FROM_CENTER * X_POSITIVE_DISTANCE_FROM_CENTER)
                    + (Y_POSITIVE_DISTANCE_FROM_CENTER * Y_POSITIVE_DISTANCE_FROM_CENTER));
    public static final double DISTANCE_TO_MODULE_1 = Math
            .sqrt((X_NEGATIVE_DISTANCE_FROM_CENTER * X_NEGATIVE_DISTANCE_FROM_CENTER)
                    + (Y_POSITIVE_DISTANCE_FROM_CENTER * Y_POSITIVE_DISTANCE_FROM_CENTER));
    public static final double DISTANCE_TO_MODULE_2 = Math
            .sqrt((X_NEGATIVE_DISTANCE_FROM_CENTER * X_NEGATIVE_DISTANCE_FROM_CENTER)
                    + (Y_NEGATIVE_DISTANCE_FROM_CENTER * Y_NEGATIVE_DISTANCE_FROM_CENTER));
    public static final double DISTANCE_TO_MODULE_3 = Math
            .sqrt((X_POSITIVE_DISTANCE_FROM_CENTER * X_POSITIVE_DISTANCE_FROM_CENTER)
                    + (Y_NEGATIVE_DISTANCE_FROM_CENTER * Y_NEGATIVE_DISTANCE_FROM_CENTER));
    ...
    public static final double[][] MODULE_UNIT_VECTORS = new double[][] {
            { X_POSITIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_0,
                    Y_POSITIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_0 },
            { X_NEGATIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_1,
                    Y_POSITIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_1 },
            { X_NEGATIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_2,
                    Y_NEGATIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_2 },
            { X_POSITIVE_DISTANCE_FROM_CENTER / DISTANCE_TO_MODULE_3,
    ...
    static{
        ...
        SHOOTER_LOOKUP_TABLE.put(12.0, 12000.0);//13370
        SHOOTER_LOOKUP_TABLE.put(13.0, 11250.0);//12700
        SHOOTER_LOOKUP_TABLE.put(14.0, 11250.0);//12400
        SHOOTER_LOOKUP_TABLE.put(15.0, 11150.0);//12150
        SHOOTER_LOOKUP_TABLE.put(16.0, 11500.0);//12150
        SHOOTER_LOOKUP_TABLE.put(17.0, 11750.0);//12750
        SHOOTER_LOOKUP_TABLE.put(18.0, 12000.0);//12400
        SHOOTER_LOOKUP_TABLE.put(19.0, 12450.0);//12450
        SHOOTER_LOOKUP_TABLE.put(20.0, 12600.0);//12600
    }
