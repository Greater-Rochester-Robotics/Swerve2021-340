...
public class SnekLoader extends SubsystemBase {
  ...
  public void periodic() {
    ...
    switch (state) {
    case kSpitBalls:
      speeds = new double[] {  -.85, -.7, -.6, -.5 };
      ballsLoaded = 0;
      break;
    case kFillTo4:
      enableOneLimit(4);
      speeds = new double[] {  MOTOR_IN_SPEED1, MOTOR_IN_SPEED2, MOTOR_IN_SPEED3, MOTOR_IN_SPEED4 };
    ...
    case kFillTo3:
      speeds = new double[] {  MOTOR_IN_SPEED1, MOTOR_IN_SPEED2, MOTOR_IN_SPEED4, 0.0 };
      enableOneLimit(3);
    ...
    case kFillTo2:
      speeds = new double[] {  MOTOR_IN_SPEED1, MOTOR_IN_SPEED4, 0.0, 0.0 };
      enableOneLimit(2);
    ...
    case kFillTo1:
      speeds = new double[] {  MOTOR_IN_SPEED4, 0.0, 0.0, 0.0 };
      enableOneLimit(1);
    ...
    case kShootBall4:
      speeds = new double[] {  0.0, 0.0, 0.0, 1.0 };
      enableOneLimit(-1);
      break;

    case kShootBall3:
      speeds = new double[] {  0.0, 0.0, .9, 1.0 };
      enableOneLimit(-1);
      break;

    case kShootBall2:
      speeds = new double[] {  0.0, .7, .85, 1.0 };
      enableOneLimit(-1);
      break;

    case kShootBall1:
      speeds = new double[] {  .5, .7, .85, 1.0 };
      enableOneLimit(-1);
      break;
    case kShootBall0:
      speeds = new double[] {  .65, .85, 1.0, 1.0 }; //.3,.5,.75,1.0,1.0
      enableOneLimit(-1);
      break;
    default:
        speeds = new double[] {0.0,0.0,0.0,0.0};
